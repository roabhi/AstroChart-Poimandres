...
class SVG {
  ...
  getSignColor(sign: string): string {
    return this.settings.SIGNS_COLORS?.[sign] ?? this.settings.SIGNS_COLOR
  }
 ...
 */
  aries(x: number, y: number): Element {
    ...
    node.setAttribute('stroke', this.getSignColor(this.settings.SYMBOL_ARIES))
 ...
 */
  taurus(x: number, y: number): Element {
    ...
    node.setAttribute('stroke', this.getSignColor(this.settings.SYMBOL_TAURUS))
    node.setAttribute('stroke-width', this.settings.SIGNS_STROKE.toString())
    node.setAttribute('fill', 'none')
    wrapper.appendChild(node)
 ...
 */
  gemini(x: number, y: number): Element {
    ...
    node.setAttribute('stroke', this.getSignColor(this.settings.SYMBOL_GEMINI))
    node.setAttribute('stroke-width', this.settings.SIGNS_STROKE.toString())
    node.setAttribute('fill', 'none')
    wrapper.appendChild(node)
 ...
 */
  cancer(x: number, y: number): Element {
    ...
    node.setAttribute('stroke', this.getSignColor(this.settings.SYMBOL_CANCER))
    node.setAttribute('stroke-width', this.settings.SIGNS_STROKE.toString())
    node.setAttribute('fill', 'none')
    wrapper.appendChild(node)
 ...
 */
  leo(x: number, y: number): Element {
    ...
    node.setAttribute('stroke', this.getSignColor(this.settings.SYMBOL_LEO))
    node.setAttribute('stroke-width', this.settings.SIGNS_STROKE.toString())
    node.setAttribute('fill', 'none')
    wrapper.appendChild(node)
 ...
 */
  virgo(x: number, y: number): Element {
    ...
    node.setAttribute('stroke', this.getSignColor(this.settings.SYMBOL_VIRGO))
    node.setAttribute('stroke-width', this.settings.SIGNS_STROKE.toString())
    node.setAttribute('fill', 'none')
    wrapper.appendChild(node)
 ...
 */
  libra(x: number, y: number): Element {
    ...
    node.setAttribute('stroke', this.getSignColor(this.settings.SYMBOL_LIBRA))
    node.setAttribute('stroke-width', this.settings.SIGNS_STROKE.toString())
    node.setAttribute('fill', 'none')
    wrapper.appendChild(node)
 ...
 */
  scorpio(x: number, y: number): Element {
    ...
    node.setAttribute('stroke', this.getSignColor(this.settings.SYMBOL_SCORPIO))
    node.setAttribute('stroke-width', this.settings.SIGNS_STROKE.toString())
    node.setAttribute('fill', 'none')
    wrapper.appendChild(node)
 ...
 */
  sagittarius(x: number, y: number): Element {
    ...
    node.setAttribute('stroke', this.getSignColor(this.settings.SYMBOL_SAGITTARIUS))
    node.setAttribute('stroke-width', this.settings.SIGNS_STROKE.toString())
    node.setAttribute('fill', 'none')
    wrapper.appendChild(node)
 ...
 */
  capricorn(x: number, y: number): Element {
    ...
    node.setAttribute('stroke', this.getSignColor(this.settings.SYMBOL_CAPRICORN))
    node.setAttribute('stroke-width', this.settings.SIGNS_STROKE.toString())
    node.setAttribute('fill', 'none')
    wrapper.appendChild(node)
 ...
 */
  aquarius(x: number, y: number): Element {
    ...
    node.setAttribute('stroke', this.getSignColor(this.settings.SYMBOL_AQUARIUS))
    node.setAttribute('stroke-width', this.settings.SIGNS_STROKE.toString())
    node.setAttribute('fill', 'none')
    wrapper.appendChild(node)
 ...
 */
  pisces(x: number, y: number): Element {
    ...
    node.setAttribute('stroke', this.getSignColor(this.settings.SYMBOL_PISCES))
    node.setAttribute('stroke-width', this.settings.SIGNS_STROKE.toString())
    node.setAttribute('fill', 'none')
    wrapper.appendChild(node)
 ...
 */
  // `size` accepts a number as well as a string: POINTS_TEXT_SIZE is typed
  // number, and every upstream call site passed it straight through without a
  // type error only because those calls sit inside `function () {}` bodies
  // where `this` is implicitly any. Widening here removes the trap.
  text(txt: string, x: number, y: number, size: string | number, color: string): Element {
    ...
    text.setAttribute('font-family', this.settings.FONT_FAMILY)
